...
mixin _$EventDto {
  ...
  List<EventConfirmationDto> get confirmations =>
      throw _privateConstructorUsedError;
  /** Liczba powiadomionych widzów (po createEvent) – do komunikatu „Jesteś 1 z X”. */
...
class _$EventDtoCopyWithImpl<$Res, $Val extends EventDto>
  ...
  $Res call({
    ...
    Object? recipientsCount = freezed,
  }) {
    return _then(_value.copyWith(
      id: null == id
          ? _value.id
      ...
      recipientsCount: freezed == recipientsCount
...
/** Liczba powiadomionych widzów (po createEvent) – do komunikatu „Jesteś 1 z X”. */
  ...
  @override
  String toString() {
    return 'EventDto(id: $id, initiatorDeviceId: $initiatorDeviceId, programId: $programId, status: $status, initiatedAt: $initiatedAt, validatedAt: $validatedAt, expiresAt: $expiresAt, followerCountLimit: $followerCountLimit, program: $program, confirmations: $confirmations, recipientsCount: $recipientsCount)';
  }
...
abstract class _EventDto implements EventDto {
  const factory _EventDto(
      ...
      final List<EventConfirmationDto> confirmations,
      final int? recipientsCount}) = _$EventDtoImpl;
