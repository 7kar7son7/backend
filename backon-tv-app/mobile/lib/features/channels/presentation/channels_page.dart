        ...
        child: state.when(
          ...
          data: (viewState) {
            ...
            final slivers = <Widget>[
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: _TimeLineBar()),
                      const SizedBox(width: 8),
                      // Ikona icon_AO – po wejściu otwiera ekran z literami A–Z
                      IconButton(
                        icon: const Icon(Icons.sort_by_alpha),
                        onPressed: () => context.push('/home/channels/letters'),
            ...
            if (_searchQuery.isNotEmpty && _searchQuery.length >= 3) {
              ...
              // Stały baner na górze listy – zawsze widoczny
              slivers.add(
                SliverToBoxAdapter(
                  child: Padding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        ...
                        // Usunięto baner "Czy reklamy się skończyły?" – tylko okienko z kciukami po wejściu z pusha
...
/// Slot reklamy w liście kanałów – ładuje banner po zamontowaniu (co 4. karta).
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Wróć później lub odśwież listę.',
              textAlign: TextAlign.center,
              style: theme.textTheme.bodySmall?.copyWith(
